<?php checkLoggedIn(); // REMEMBER TO ADD ADMIN LOCK ON THIS PAGE ?>
...
<head>
	...
	<title>Staff management - <?php echo $name; ?></title>
...
<body class="fixed-header">
	...
	<div id="wrapper">	
		...
		<section class="elements">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 co-xs-12 margin-bottom-sm-30">
						<div class="panel panel-warning">
							<div class="panel-heading">
								<h3 class="panel-title">Staff invitation</h3>
							</div>
							
							<div class="panel-body">
								<div class="col-md-10 text-center">
									<input type="text" class="form-control" name="forumname" id="forumname" placeholder="Forum name">
								</div>
								
								<button type="button" class="btn btn-primary">Invite</button><br><br>
    ...
    <option>Toilet Paper</option>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 co-xs-12 margin-bottom-sm-30">
						<div class="panel panel-inverse">
							<div class="panel-heading">
								<h3 class="panel-title">Staff removal</h3>
							</div>
				...
				<div class="row margin-top-30">
					<div class="col-lg-4 col-md-4 col-sm-4 co-xs-12 margin-bottom-sm-30">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h3 class="panel-title">Helper team</h3>
							</div>
							<div class="panel-body">
								This feature is still in development.
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 co-xs-12 margin-bottom-sm-30">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">Administration team</h3>
							</div>
							<div class="panel-body">
								This feature is still in development.
							</div>
